...
powershell -ExecutionPolicy Bypass -Command "Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/yusufburhani20/remoteallos/64b4cf884b3c55c80738cf2185febf89dbbba8d8/agent/install-windows.ps1' | Invoke-Expression"
